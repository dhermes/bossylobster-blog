# Via https://raw.githubusercontent.com/getpelican/pelican-plugins/master/summary/summary.py
# NOTE: I manually vendored this in because the `pelican-plugins` repository is
#       too large to include as a submodule.
...
def extract_summary(instance):
    ...
    content = instance._update_content(
        instance._content, instance.settings["SITEURL"]
    )
    begin_summary = -1
    end_summary = -1
    if begin_marker:
